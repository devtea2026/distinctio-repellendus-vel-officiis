...
[![NPM](https://badge.fury.io/js/@devtea2026/distinctio-repellendus-vel-officiis.svg)](https://badge.fury.io/js/@devtea2026/distinctio-repellendus-vel-officiis)
![CI test](https://github.com/devtea2026/distinctio-repellendus-vel-officiis/workflows/ci-test/badge.svg)
[![Coverage Status](https://coveralls.io/repos/github/ndaidong/@devtea2026/distinctio-repellendus-vel-officiis/badge.svg)](https://coveralls.io/github/ndaidong/@devtea2026/distinctio-repellendus-vel-officiis)
![CodeQL](https://github.com/devtea2026/distinctio-repellendus-vel-officiis/workflows/CodeQL/badge.svg)
[![CodeFactor](https://www.codefactor.io/repository/github/ndaidong/@devtea2026/distinctio-repellendus-vel-officiis/badge)](https://www.codefactor.io/repository/github/ndaidong/@devtea2026/distinctio-repellendus-vel-officiis)
...
```bash
npm i @devtea2026/distinctio-repellendus-vel-officiis

# pnpm
pnpm i @devtea2026/distinctio-repellendus-vel-officiis

# yarn
yarn add @devtea2026/distinctio-repellendus-vel-officiis
```

### Deno

```ts
import { genid } from 'https://esm.sh/@devtea2026/distinctio-repellendus-vel-officiis'
...
```html
<script type="module">
import { genid, slugify } from 'https://unpkg.com/@devtea2026/distinctio-repellendus-vel-officiis/dist/bella.esm.js'
...
```js
import { clone } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { copies } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { pick } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { sort } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { sortBy } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { shuffle } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { unique } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { curry } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { compose } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { pipe } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { maybe } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
import {
  formatDateString
} from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { randint } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```js
import { genid } from '@devtea2026/distinctio-repellendus-vel-officiis'
...
```bash
git clone https://github.com/devtea2026/distinctio-repellendus-vel-officiis.git
cd @devtea2026/distinctio-repellendus-vel-officiis
npm install
npm test
```
